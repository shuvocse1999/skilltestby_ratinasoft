...
<div class="content-body">
	<div class="container-fluid mt-3">
		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">All Supplier <a href="{{ url('addsupplier') }}" class="float-right btn btn-dark btn-sm">Add Supplier</a></h4>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												{{-- <a class="dropdown-item" href="{{ url("editsupplier/".$d->id) }}">Edit</a> --}}
